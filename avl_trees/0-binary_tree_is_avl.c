...
/**
 * tree_height - measuring the height og the binary tree
...
/**
 * isBST - checking if each node has in the left a less value than itself
 * @root: node to be checked
...
/**
 * avl_check - checking if the tree is AVL or not
...
/**
 * binary_tree_is_avl - checking if the tree is AVL or not
 * @tree: pointer to the root node of the tree to check
 *
 * Return: 1 if tree is a valid AVL Tree and 0 otherwise
 */
